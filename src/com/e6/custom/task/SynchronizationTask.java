...
public class SynchronizationTask extends BaseCronJob {
	...
	static {
		...
		while (hrre.next()) {
			...
			if (hrm_fieldlable.equals("社保电脑号")) {
				zcdj = fieldlabel;
			}
			if (hrm_fieldlable.equals("户籍地址")) {
				zwdj = fieldlabel;
			}
			if (hrm_fieldlable.equals("参保单位")) {
				cbzx = fieldlabel;
			}
			if (hrm_fieldlable.equals("住房公积金账号")) {
				gzxz = fieldlabel;
			}
			if (hrm_fieldlable.equals("习惯手")) {
				xzlb = fieldlabel;
			}
			if (hrm_fieldlable.equals("是否购买住房公积金")) {
				syb = fieldlabel;
			}
			if (hrm_fieldlable.equals("参保档次")) {
				yjbm = fieldlabel;
			}
			if (hrm_fieldlable.equals("核算单位")) {
				ejbm = fieldlabel;
			}
			if (hrm_fieldlable.equals("户籍类型")) {
				fjlx = fieldlabel;
			}
		}
